            ...
            <div>
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-14 h-14 border-3 border-[#1877F2] rounded-full flex items-center justify-center hover:bg-[#1877F2]/10 transition-all hover:-translate-y-1 cursor-pointer"
                  aria-label="Visit our Facebook page"
                  data-testid="link-facebook"
                >
                  <svg className="w-7 h-7 text-[#1877F2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
                </a>
                {/* Instagram Link */}
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-14 h-14 border-3 border-[#E4405F] rounded-full flex items-center justify-center hover:bg-[#E4405F]/10 transition-all hover:-translate-y-1 cursor-pointer"
                  aria-label="Follow us on Instagram"
                  data-testid="link-instagram"
                >
                  <svg className="w-7 h-7 text-[#E4405F]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M7.8 2h8.4C19.4 2 22 4.6 22 7.8v8.4c0 3.2-2.6 5.8-5.8 5.8H7.8C4.6 22 2 19.4 2 16.2V7.8C2 4.6 4.6 2 7.8 2zm0 2C5.7 4 4 5.7 4 7.8v8.4c0 2.1 1.7 3.8 3.8 3.8h8.4c2.1 0 3.8-1.7 3.8-3.8V7.8c0-2.1-1.7-3.8-3.8-3.8H7.8zm8.5 3c.8 0 1.5-.7 1.5-1.5s-.7-1.5-1.5-1.5-1.5.7-1.5 1.5.7 1.5 1.5 1.5zm-4.3 2c2.9 0 5.3 2.4 5.3 5.3s-2.4 5.3-5.3 5.3-5.3-2.4-5.3-5.3 2.4-5.3 5.3-5.3zm0 2c-1.8 0-3.3 1.5-3.3 3.3s1.5 3.3 3.3 3.3 3.3-1.5 3.3-3.3-1.5-3.3-3.3-3.3z" /></svg>
                </a>
                {/* WhatsApp Link */}
                <a 
                  href={config.social.whatsappLink} 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-14 h-14 border-3 border-[#25D366] rounded-full flex items-center justify-center hover:bg-[#25D366]/10 transition-all hover:-translate-y-1 cursor-pointer"
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-14 h-14 border-3 border-[#0A66C2] rounded-full flex items-center justify-center hover:bg-[#0A66C2]/10 transition-all hover:-translate-y-1 cursor-pointer"
